        ...
        return (
            <div>
                ...
                <Card className="card">
                    <CardHeader 
                    avatar={
                        <Avatar src="https://data.whicdn.com/images/304551518/original.jpg" className="avap"/>
                    }
                    ...
                    subheader={
                        <div>
                            <a className={btn_class} onClick={this.handleChange.bind(this)}>Alden Cantrell </a>
                    ...
                    <CardHeader 
                    avatar={
                        <Avatar src="https://images.unsplash.com/photo-1526116977494-90748acc0cad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80" className="avap"/>
                    }
                    subheader={
                        <div>
                            <a className={btn_class} onClick={this.handleChange.bind(this)}>Kierra Gentry </a>
                    ...
                    subheader={
                        <div>
                            <a className={btn_class} onClick={this.handleChange.bind(this)}>Bradyn Kramer </a>
                            <a className="notify">commented on your post. </a>
                            <a className="notify">7d </a>
                        </div>
                    }
